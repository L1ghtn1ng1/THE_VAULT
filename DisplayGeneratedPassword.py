...
class page():
    def create(self):
        ...
        # Now create random string of length 8 which is a combination of letters and digits
        ...
        self.goBack = ttk.Button(
            self,
            text="Return", command=lambda:self.changePage(1)) # Button purpose to go back to Menu page.
